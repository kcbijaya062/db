...
//  // inserting user into userAccountData from here
//  $query_insert_user = "INSERT INTO UserAccountData (username, password) 
//  VALUES (:username, :password,)";

//  $cursor_insert_user = oci_parse($connection, $query_insert_user);

//  oci_bind_by_name($cursor_insert_user, ':username', $username);
//  oci_bind_by_name($cursor_insert_user, ':password', $password);

//  $result_insert_user = oci_execute($cursor_insert_user);
//  if (!$result_insert_user) {
//      $error_message = oci_error($cursor_insert_user)['message'];
//      die("Error inserting into UserAccountData table: $error_message");
//  }
include"listallstudents.php";
 oci_commit($connection);

 oci_free_statement($cursor_insert_user);
